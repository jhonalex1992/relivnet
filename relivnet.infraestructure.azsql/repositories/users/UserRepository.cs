...
public class UserRepository : GenericDataMedianetDbRepository<UserEntity>, IUserDomainRepository
{
    
    public UserRepository(RelivnetDbContext contex) : base(contex)
    {
        Context = contex;
    }
